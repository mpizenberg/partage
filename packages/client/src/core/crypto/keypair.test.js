...
import { generateKeypair, hashPublicKey, exportKeypair, importKeypair, exportPublicKey, importPublicKey, deriveSharedKey, } from './keypair';
...
describe('Keypair Management (ECDH P-256)', () => {
    ...
    describe('Security Properties', () => {
        ...
        it('should not allow deriving private key from public key', async () => {
            ...
            await expect(deriveSharedKey(imported, otherKeypair.publicKey)).rejects.toThrow();
        });
    });
});
