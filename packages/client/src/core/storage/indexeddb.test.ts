...
import { DEFAULT_GROUP_SETTINGS, type SerializedKeypair, type Group } from '@partage/shared';
...
describe('IndexedDB Storage', () => {
  ...
  describe('Identity Management', () => {
    const mockKeypair: SerializedKeypair = {
      publicKey: 'public123',
    ...
    it('should update existing keypair', async () => {
      ...
      const updatedKeypair: SerializedKeypair = {
        publicKey: 'newPublic',
