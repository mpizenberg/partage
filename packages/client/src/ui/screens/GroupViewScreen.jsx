...
export const GroupViewScreen = () => {
    ...
    return (<div class="group-view-screen">
      {/* Header */}
      ...
      <div class="tabs-container">
        <div class="container">
          <div class="tabs">
            <button class={`tab ${activeTab() === 'balance' ? 'active' : ''}`} onClick={() => setActiveTab('balance')}>
              Balance
            </button>
      ...
      {/* Floating Add Button */}
      <button class="fab" onClick={() => setShowAddEntry(true)} aria-label="Add entry">
        +
      </button>

      {/* Add Entry Modal */}
      <AddEntryModal isOpen={showAddEntry()} onClose={() => setShowAddEntry(false)} onAddExpense={addExpense} onAddTransfer={addTransfer}/>
    </div>);
};
