...
export const CreateGroupScreen = (props) => {
        ...
        <form onSubmit={handleSubmit}>
          <div class="card mb-lg">
            ...
            <div class="form-group">
              ...
              <Input id="group-name" type="text" value={groupName()} placeholder="e.g., Weekend Trip, Apartment 42" onInput={(e) => {
            setGroupName(e.currentTarget.value);
            setValidationError(null);
        }} required error={!groupName().trim() && !!validationError()}/>
            </div>
            ...
            <div class="form-group">
              ...
              <Select id="currency" value={currency()} options={CURRENCIES} onChange={(e) => setCurrency(e.currentTarget.value)} required/>
              <p class="form-hint">
          ...
          {/* Members */}
          <div class="card mb-lg">
            <MemberManager currentUserName="You" currentUserId={identity()?.publicKeyHash || ''} members={allMembers()} onAddMember={handleAddMember} onRemoveMember={handleRemoveMember}/>
          </div>
          ...
          <div class="flex gap-sm">
            <Button type="button" variant="secondary" onClick={props.onCancel} disabled={isLoading()} class="flex-1">
              Cancel
            </Button>
