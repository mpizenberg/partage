...
export const BalanceTab = () => {
    ...
    return (<div class="balance-tab">
      <Show when={hasEntries()} fallback={<div class="empty-state">
        ...
        <Show when={myBalance()}>
          <div class="balance-section">
            ...
            <BalanceCard balance={myBalance()} memberName="You" currency={currency()} isCurrentUser={true}/>
          </div>
        </Show>
          ...
          <div class="balance-section">
            ...
            <div class="balance-list">
              <For each={otherBalances()}>
                {([memberId, balance]) => (<BalanceCard balance={balance} memberName={getMemberName(memberId)} currency={currency()}/>)}
              </For>
            </div>
          </div>
        </Show>
        ...
        {/* Settlement Plan */}
        <div class="balance-section">
          <SettlementPlan plan={settlementPlan()} currency={currency()} members={members()}/>
        </div>
      </Show>
    </div>);
};
