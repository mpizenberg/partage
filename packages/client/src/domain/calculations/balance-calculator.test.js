...
import { calculateBalances, buildDebtGraph, generateSettlementPlan, getTotalSettlementAmount, isBalanceSettled, areAllBalancesSettled, } from './balance-calculator';
describe('Balance Calculator', () => {
    ...
    describe('generateSettlementPlan', () => {
        ...
        it('should apply must-not constraints', () => {
            ...
            const hasProhibitedTransaction = plan.transactions.some((t) => t.from === 'C' && t.to === 'A');
